...
if(isset($_GET['id'])){
    ...
    foreach ($comments as $comment){
        echo "<div name='".$comment['annoucementID']."C'style='background-color: white;'>\r\n".
              ...
              "<p style='width: 100%; margin-left: 50px; margin-right: 20px; font-size:16px; height: 96px; border-color: black; border-width: 1px;'>".nl2br(htmlspecialchars($comment['content']))."</p>\r\n".
