...
if(isset($_GET['id'])){
    ...
    foreach ($comments as $comment){
        $creator = $db->query("Select username from user WHERE id =". $comments['userID'] ." ORDER BY id DESC");
        echo "<div name='".$comment['annoucementID']->fetch(PDO::FETCH_ASSOC)[0]['username']."C'style='background-color: white;'>\r\n".
              "\r\n <p style='font-size:16px'>$creator</p>".
